...
namespace cw10.Migrations
{
    ...
    [Migration("20240608121024_AddData2")]
            ...
            modelBuilder.Entity("cw10.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2024, 6, 8, 14, 10, 24, 390, DateTimeKind.Local).AddTicks(9620),
                            FirstName = "Pep",
                            LastName = "Trol"
                        });
                });
            ...
            modelBuilder.Entity("cw10.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2024, 6, 8, 14, 10, 24, 390, DateTimeKind.Local).AddTicks(9700),
                            DueDate = new DateTime(2024, 6, 8, 14, 10, 24, 390, DateTimeKind.Local).AddTicks(9700),
                            IdDoctor = 2,
                            IdPatient = 1
                        });
                });
